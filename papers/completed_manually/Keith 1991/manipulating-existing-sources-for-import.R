...
# read data
data <- read.csv('data/dharawal/dharawal_84_89.csv',
...
traits <- read_csv('data/dharawal/dharawal_84_89_traits.csv')[1:17, ]
species <- read_csv('data/dharawal/dharawal_84_89_species.csv')
